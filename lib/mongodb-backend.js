...
MongoDBBackend.prototype = {
  ...
  */
  get : function(bucket, key, cb){
    ...
    try {
      var collection = this.db.collection(this.prefix + this.removeUnsupportedChar(collName));
  ...
  */
  add : function(transaction, bucket, key, values){
    ...
    transaction.push(function(cb){
      ...
      try {
        var collection = self.db.collection(self.prefix + self.removeUnsupportedChar(collName));
